...
int main(){
    ...
    // Que-1] Print the address of String in cpp
    string s = "1234";
    cout << &s;
    cout<<endl;
    
    //Que-2] Create a ptr which will store the address of last element, then print all the elements 
    // from the last index to 0th index with the help of a pointer
